...
try:
    ...
    from lib.cuckoo.core.startup import check_working_directory, check_configs, cuckoo_clean, cuckoo_clean_failed_tasks
    from lib.cuckoo.core.startup import cuckoo_clean_failed_url_tasks, cuckoo_clean_before_day, cuckoo_get_max_task_id
    from lib.cuckoo.core.startup import cuckoo_clean_sorted_pcap_dump, cuckoo_clean_bson_suri_logs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pending-clean", help="Remove all pending tasks STARTING_TASK through ENDING_TASK", nargs=2,
                        metavar=('STARTING_TASK', 'ENDING_TASK'), type=int, required=False)
    ...
    if args.tasks_clean:
        cuckoo_clean_tasks(args.tasks_clean)
        sys.exit(0)
