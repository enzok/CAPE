rule Ursnif
{
    ...
    condition:
        uint16(0) == 0x5A4D and (any of ($decrypt32*)) or (any of ($decrypt64*)) or ((all of ($b*)) and $c1 or $d1) or (all of ($a*)) or ((any of ($crypto64*) and $parse_config64) or (any of ($crypto32*) and $parse_config32))
}
