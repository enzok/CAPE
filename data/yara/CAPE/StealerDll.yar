rule StealerDll
{
    ...
    strings:
        $cb1 = { 53 BA 07 00 00 00 83 EC 04 C7 04 24 00 00 00 00 4A 75 F3 8B 44 24 2C A3 [3] 10 8B 54 24 24 8D 0C 24 E8 [4] 8B 54 24 28 8D 4C 24 04 E8 [4] 8B 54 24 04 }
